...
int main() {
    TradeLoader sl;
    sl.load("../Datafiler Aktiekurs/COLOB.DKDKK_Candlestick_1_M_BID_01.01.2017-31.12.2017.csv");
    sl.load("../Datafiler Aktiekurs/COLOB.DKDKK_Candlestick_1_M_BID_01.01.2018-31.12.2018.csv");
    sl.load("../Datafiler Aktiekurs/COLOB.DKDKK_Candlestick_1_M_BID_01.01.2019-31.12.2019.csv");
    sl.load("../Datafiler Aktiekurs/COLOB.DKDKK_Candlestick_1_M_BID_01.01.2020-31.12.2020.csv");
    sl.load("../Datafiler Aktiekurs/COLOB.DKDKK_Candlestick_1_M_BID_01.01.2021-31.12.2021.csv");
    sl.load("../Datafiler Aktiekurs/COLOB.DKDKK_Candlestick_1_M_BID_01.01.2022-31.12.2022.csv");
    sl.load("../Datafiler Aktiekurs/COLOB.DKDKK_Candlestick_1_M_BID_01.01.2023-21.03.2023.csv");
